...
function writeTypeDefsFile(filePath) {
    (0, _1.writeTypeDefs)(filePath, (0, _1.returnTypeDefs)());
}
...
function writeTypedefsToProduction() {
    ...
    if (checkFileExists(filePath)) {
        ...
        //create file
        (0, fs_1.writeFileSync)(filePath, "", { flag: "wx" });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, writeTypeDefsFile(path.join(__dirname) + "/typedefs.txt")];
            case 2:
                //write to development folder
                _a.sent();
                //write to production folder
                return [4 /*yield*/, writeTypedefsToProduction()];
            case 3:
                //write to production folder
                _a.sent();
                return [2 /*return*/];
